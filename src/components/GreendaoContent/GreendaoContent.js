    ...
    <Row>
      <Col>
        ...
        <p>
          ...
          activities such as social philanthropy, equality and conservation. The
          Decentralised Autonomous Organisation (DAO) serves to create a
          consensus network to determine the value of various non-carbon related
          activities, and to create a erse and international network for
          like-minded individuals in the ustainability space to share
